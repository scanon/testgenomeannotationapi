...
function testGenomeAnnotationAPI(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.get_taxon = function (ref, _callback, _errorCallback) {
        ...
        return json_call_ajax("testGenomeAnnotationAPI.get_taxon",
     ...
     this.get_assembly = function (ref, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_assembly",
            [ref], 1, _callback, _errorCallback);
    };
     ...
     this.get_feature_types = function (ref, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_feature_types",
            [ref], 1, _callback, _errorCallback);
    };
     ...
     this.get_feature_type_descriptions = function (ref, feature_type_list, _callback, _errorCallback) {
        ...
        return json_call_ajax("testGenomeAnnotationAPI.get_feature_type_descriptions",
     ...
     this.get_feature_type_counts = function (ref, feature_type_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_feature_type_counts",
            [ref, feature_type_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_feature_ids = function (ref, filters, group_type, _callback, _errorCallback) {
        ...
        return json_call_ajax("testGenomeAnnotationAPI.get_feature_ids",
     ...
     this.get_features = function (ref, feature_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_features",
     ...
     this.get_proteins = function (ref, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_proteins",
            [ref], 1, _callback, _errorCallback);
    };
     ...
     this.get_feature_locations = function (ref, feature_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_feature_locations",
            [ref, feature_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_feature_publications = function (ref, feature_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_feature_publications",
            [ref, feature_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_feature_dna = function (ref, feature_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_feature_dna",
            [ref, feature_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_feature_functions = function (ref, feature_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_feature_functions",
            [ref, feature_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_feature_aliases = function (ref, feature_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_feature_aliases",
            [ref, feature_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_cds_by_gene = function (ref, gene_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_cds_by_gene",
     ...
     this.get_cds_by_mrna = function (ref, mrna_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_cds_by_mrna",
     ...
     this.get_gene_by_cds = function (ref, cds_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_gene_by_cds",
     ...
     this.get_gene_by_mrna = function (ref, mrna_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_gene_by_mrna",
            [ref, mrna_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_mrna_by_cds = function (ref, cds_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_mrna_by_cds",
            [ref, cds_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_mrna_by_gene = function (ref, gene_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_mrna_by_gene",
            [ref, gene_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_mrna_exons = function (ref, mrna_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_mrna_exons",
            [ref, mrna_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_mrna_utrs = function (ref, mrna_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 2+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(2+2)+')';
        return json_call_ajax("testGenomeAnnotationAPI.get_mrna_utrs",
            [ref, mrna_id_list], 1, _callback, _errorCallback);
    };
